          ...
          <form onSubmit={guardar} className="space-y-5">
            ...
            <div className="rounded-xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900 p-5">
              ...
              <textarea
                ...
                placeholder="¡Hola! Soy Natalia de VELOSTRATEGIX..."
              />
            ...
            <div className="rounded-xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900 p-5">
              ...
              <textarea
                ...
                placeholder="Eres [nombre], un Sales Development Representative de [empresa]..."
              />
              <p className="mt-1 text-xs text-zinc-400">
                Tip: incluye instrucciones para pedir email y agendar reunión antes de cerrar la llamada.
              </p>
            </div>
