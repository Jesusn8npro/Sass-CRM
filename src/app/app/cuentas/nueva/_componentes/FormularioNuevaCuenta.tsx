      ...
      <form onSubmit={crear} className="flex flex-col gap-4">
        <div>
          ...
          <input
            ...
            maxLength={60}
            autoFocus
            className="w-full rounded-xl border border-zinc-200 bg-white px-4 py-2.5 text-sm focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 dark:border-zinc-700 dark:bg-zinc-950"
          />
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          >
            {creando ? "Creando…" : "Crear cuenta y escanear QR →"}
          </button>
        </div>
