/**
 * Catálogo público de plantillas de funnel — sólo data + tipos.
 * Sin imports de DB; safe para client components (onboarding wizard).
 * La aplicación a la cuenta vive en plantillasFunnel.ts (server-only).
 */
