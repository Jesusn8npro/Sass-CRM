  ...
  if (bdExternaActiva) {
    ...
    promptCompleto +=
      ...
      (tieneLookupAlumno
        ...
        `- Para listar QUÉ cursos/tutoriales/paquetes TIENE el alumno (su acceso, su contenido, "qué tengo en mi perfil", "no puedo acceder a mis tutoriales", "qué compré") → consultá "vista_alumno_contenido" con filtros [{"columna":"whatsapp_10","valor":"${telVerif10}"}]. Cada fila es tipo (curso/tutorial/paquete) + contenido (título) + estado. Listale sus títulos reales; NO digas "déjame verificar".\n`
        : "") +
