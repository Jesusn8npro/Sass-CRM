...
export function InterruptorModo({
  ...
  return (
    <div
      className="inline-flex items-center gap-1 rounded-full border border-zinc-200 bg-white/80 p-1 backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-900/60"
      role="group"
    ...
    >
      <button
        ...
        onClick={() => cambiar("IA")}
        disabled={enviando}
        className={`flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-medium tracking-wide uppercase transition-all duration-200 disabled:opacity-50 ${
          esIA
