...
export function PanelConversacion({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div
        ref={refScroll}
        className="min-h-0 flex-1 overflow-y-auto bg-zinc-50 px-3 py-4 md:px-6 md:py-6 dark:bg-zinc-950"
        style={{
          backgroundImage:
            "radial-gradient(circle at 1px 1px, rgba(120,120,120,0.10) 1px, transparent 0)",
